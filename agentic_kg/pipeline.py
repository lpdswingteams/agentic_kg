"""Agentic knowledge governance pipeline using LangChain 1.0 primitives."""
...
class PipelineConfig:
    ...
    top_k: int = 4
    semantic_dimension: Optional[int] = None
    ...
    def _ensure_strategies(self, documents: Iterable[Document]) -> List[ChunkingStrategyConfig]:
        if self._strategies is None:
            self._strategies = build_default_strategies(
                ...
                embedding_dimension=self.config.semantic_dimension,
            )
