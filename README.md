...
一个最小可运行的示例，用于基于 LangChain >1.0 构建“agentic”知识治理智能体：
...
> 如使用新版 LangChain，请确保安装了 `langchain-text-splitters` 与 `langchain-experimental`。
...
- `PipelineConfig`：配置 embedding 模型、检索 top_k 和语义维度等。
